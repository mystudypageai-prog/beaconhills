...
export default function SettingsPage() {
  ...
  const submitKyc = async () => {
    if (!frontDoc || !selfie) {
      setKycMsg("Please upload required documents.");
      return;
    }
          ...
          {activeTab === "security" && (
            <div className={styles.section}>
              ...
              <button
                ...
                disabled={saving || !currentPass || !newPass}
              >
            ...
            <div className={styles.section}>
              ...
              <div
                style={{
                  ...
                  padding: "14px",
                  borderRadius: "10px",
                  background: `${kycBadgeColor}18`,
                  border: `1px solid ${kycBadgeColor}40`,
                  marginBottom: "20px",
                }}
              >
                <div
                ...
                <div>
                  ...
                  >
                    {kycStatus === "none" &&
                      "Submit your documents to enable withdrawals"}
                    {kycStatus === "pending" &&
                      "Under review - usually completed within 24 hours"}
                    {kycStatus === "approved" &&
                      "Full access enabled. All features unlocked."}
                    {kycStatus === "rejected" &&
              ...
              {kycMsg && (
                <div
                  style={{
                    background: kycMsg.includes("success")
                      ? "rgba(34,200,83,0.1)"
                      : "rgba(239,68,68,0.1)",
                    color: kycMsg.includes("success") ? "#22c55e" : "#f87171",
                    padding: "10px 14px",
                    borderRadius: "8px",
                    fontSize: "13px",
                    marginBottom: "16px",
                ...
                <div>
                  ...
                  >
                    ...
                    <button
                      className={styles.saveBtn}
                      onClick={submitKyc}
                      disabled={kycSubmitting || !frontDoc || !selfie}
                    >
                ...
                {[
                  {
                    ...
                    desc: "When a deposit is approved and credited",
                    on: true,
                  },
                  {
                    label: "Withdrawal Processed",
                    desc: "When a withdrawal is approved or rejected",
                    on: true,
                  },
                  {
                    label: "KYC Status Update",
                    desc: "When your KYC is reviewed",
                    on: true,
                  },
                  {
                    label: "Security Alerts",
                    desc: "Login from new device or location",
                    on: true,
                  },
                ].map((item, i) => (
                  <div
