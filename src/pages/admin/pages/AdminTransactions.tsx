...
export default function AdminTransactions() {
  ...
  const fetchData = useCallback(() => {
    ...
    api
      .get<PaginatedResponse<Transaction>>(`/admin/transactions?${params}`)
      .then((res) => {
            ...
            {["all", "deposit", "withdrawal"].map((t) => (
              <button
                ...
                style={{
                  ...
                  fontSize: "12px",
                  background:
                    typeFilter === t ? "#1565C0" : "rgba(255,255,255,0.04)",
        ...
        {loading ? (
          ...
          <div style={{ overflowX: "auto" }}>
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "80px 1fr 140px 120px 100px 80px 120px",
                gap: "10px",
                padding: "10px 16px",
                borderBottom: "1px solid rgba(255,255,255,0.06)",
                fontSize: "11px",
