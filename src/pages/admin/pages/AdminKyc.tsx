...
export default function AdminKyc() {
  ...
  const fetchData = useCallback(() => {
    ...
    api
      .get<PaginatedResponse<KycSubmission>>(`/admin/kyc?${params}`)
      .then((res) => {
  ...
  const reject = async (id: number) => {
    ...
    setMsg("");
    try {
      const res: any = await api.post(`/admin/kyc/${id}/reject`, {
        reason: rejectReason,
      });
          ...
          >
            ...
            >
              <h3 style={{ color: "#fff", fontSize: "16px" }}>
                KYC Review - {selected.first_name} {selected.last_name}
              </h3>
              <button
                onClick={() => setSelected(null)}
                style={{
            ...
            {[
              ...
              {
                label: "Document Type",
                value: selected.document_type?.replace(/_/g, " "),
              },
            ...
            {selected.document_image_url && (
              <div style={{ marginTop: "16px" }}>
                ...
                <img
                  src={selected.document_image_url}
                  alt="Document"
                  style={{
                    width: "100%",
                    borderRadius: "8px",
