...
export default function AdminWallets() {
  ...
  const toggleActive = async (net: Network) => {
    try {
      await api.put(`/admin/networks/${net.id}`, {
        ...net,
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
      <div>
        ...
        <p style={{ color: "#9ca3af", fontSize: "13px", marginTop: "4px" }}>
          Manage deposit addresses, fees, and network settings
        </p>
      </div>
          ...
          {networks.map((net) => (
            <div
              ...
              style={{
                ...
                border: `1px solid ${net.is_active ? net.color + "30" : "rgba(255,255,255,0.06)"}`,
                borderRadius: "12px",
                padding: "20px",
                position: "relative",
              }}
            >
              ...
              >
                ...
                <div
                  onClick={() => toggleActive(net)}
                  style={{
                    width: "36px",
                    height: "20px",
                    borderRadius: "10px",
                    background: net.is_active
                      ? "#22c55e"
                ...
                {[
                  {
                    ...
                    value: net.deposit_address
                      ? `${net.deposit_address.slice(0, 18)}…`
                      : "Not set",
                    mono: true,
                  },
                  {
                    label: "Min Deposit",
                    value: `${net.min_deposit} ${net.symbol}`,
                  },
                  { label: "Fee", value: `${net.fee} ${net.symbol}` },
                  { label: "Confirmations", value: String(net.confirmations) },
                  ...(net.usd_rate
                    ? [{ label: "USD Rate", value: formatUSD(net.usd_rate) }]
                    : []),
                ].map((row) => (
                  <div
                    key={row.label}
        ...
        <>
          ...
          >
            ...
            {[
              ...
              {
                label: "USD Rate (optional override)",
                key: "usd_rate",
                type: "number",
              },
              {
