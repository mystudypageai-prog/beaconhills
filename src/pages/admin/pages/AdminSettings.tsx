      ...
      {loading ? (
        ...
        <>
          ...
          >
            ...
            >
              Control how you receive platform alerts
            </p>
            <SettingRow
              label="Email Notifications"
              desc="Receive alerts for deposits, withdrawals, and KYC"
            >
              <div
                style={toggleStyle(settings.email_notifications)}
                onClick={() =>
                  setSettings((s) => ({
                    ...s,
            ...
            >
              <div
                style={toggleStyle(settings.push_notifications)}
                onClick={() =>
                  setSettings((s) => ({
                    ...s,
          ...
          >
            ...
            >
              Fallback addresses - prefer per-network addresses in Wallets
            </p>
            <div style={{ marginBottom: "12px" }}>
              ...
              <input
                type="text"
                value={settings.deposit_wallet_eth}
                onChange={(e) =>
                  setSettings((s) => ({
                    ...s,
                    deposit_wallet_eth: e.target.value,
                  }))
                }
                placeholder="0x…"
            ...
            <div>
              ...
              <input
                type="text"
                value={settings.deposit_wallet_btc}
                onChange={(e) =>
                  setSettings((s) => ({
                    ...s,
                    deposit_wallet_btc: e.target.value,
                  }))
                }
                placeholder="bc1…"
                style={{ ...inputStyle, fontFamily: "monospace" }}
