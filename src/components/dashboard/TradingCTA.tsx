    ...
    <div className={styles.banner}>
      ...
      <div className={styles.left}>
        ...
        <p className={styles.sub}>
          Invest smarter with our curated plans - capital protection, steady
      ...
      <div className={styles.features}>
        ...
        <div className={styles.feature}>
          ...
          <div className={styles.featureText}>
            ...
            <span className={styles.featureSub}>
              256-bit encryption on all funds
            </span>
          </div>
        </div>
        <div className={styles.feature}>
...
function FintechIllustration() {
  return (
    <svg width="120" height="80" viewBox="0 0 120 80" fill="none">
      ...
      <text x="38" y="28" fontSize="8" fill="#9ca3af" fontFamily="Arial">
        Balance
      </text>
      <text
        x="36"
      ...
      {/* Upward arrow trend */}
      <polyline
        points="80,68 87,58 94,62 101,50 108,46"
        stroke="#22c55e"
        strokeWidth="2"
        strokeLinecap="round"
        fill="none"
