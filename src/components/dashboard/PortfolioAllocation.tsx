  ...
  const progressPct = nextTier
    ? Math.min(
        ...
        ((balance - tier.minBalance) /
          (nextTier.minBalance - tier.minBalance)) *
          100,
      )
    : 100;
    ...
    <div className={styles.card}>
      ...
      <div style={{ textAlign: "center", padding: "20px 0 12px" }}>
        ...
        >
          ...
          />
          <span
            style={{ fontSize: "12px", fontWeight: 600, color: tier.color }}
          >
            {tier.label} Tier
          </span>
        </div>
      ...
      {nextTier && (
        <div style={{ padding: "0 4px 12px" }}>
          ...
          <div style={{ fontSize: "10px", color: "#9ca3af", marginTop: "4px" }}>
            {formatUSD(nextTier.minBalance - balance)} more to reach{" "}
            {nextTier.label}
          </div>
        </div>
      )}
      ...
      <div style={{ padding: "0 4px" }}>
        {[
          ...
          },
          {
            ...
            color: user?.account_status === "active" ? "#22c55e" : "#ef4444",
          },
