          ...
          <div className={styles.logo}>
            {/* <div className={styles.logoIcon}>
              <img
                ...
                alt="Beacon Hills Logo"
                className={styles.logoImage}
              />
            </div> */}
            <span className={styles.logoText}>
              <span className={styles.logoBridge}>Beacon Hills</span>
            </span>
          </div>
              ...
              <div className={styles.userInfo}>
                ...
                <span className={styles.userVerified}>
                  <span
                    style={{
                      color:
                        user?.kyc_status === "approved" ? "#22c55e" : "#9ca3af",
                    }}
                  >
...
function InvestIcon() {
  return (
    <svg
      ...
      strokeLinejoin="round"
    >
      <path d="M12 2v20m10-10H2m7-7l3-3 3 3m0 10l-3 3-3-3" />
    </svg>
  );
}
